namespace FestivalManager.Entities.Sets
{
	...
	public abstract class Set:ISet
	{
		...
		public bool CanPerform()
		{
            ...
            return true;
            //if (this.Performers.Count > 0 && this.Songs.Count > 0 && PerformersHaveWorkingInstruments())
            //{
            //    return true;
            //}
            //else
        ...
        //private bool PerformersHaveWorkingInstruments()
        //{
        //    foreach (var performer in this.Performers)
        //    {
        //        if (performer.Instruments.All(i => i.IsBroken == true) || performer.Instruments.Any()==false)
        //        {
        //            return false;
        //        }
        //    }
